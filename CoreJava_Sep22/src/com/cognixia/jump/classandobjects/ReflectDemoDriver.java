...
class ReflectionDemo {
    ...
    // Constructor 1
    // Public constructor
    public ReflectionDemo(String s) { this.s = s; }
    
    public ReflectionDemo() { this.s = "Red"; }
...
public class ReflectDemoDriver {
	...
	public static void main(String[] args) throws NoSuchMethodException, SecurityException, IllegalAccessException, InvocationTargetException, NoSuchFieldException {
        ...
        // method
		ReflectionDemo obj = new ReflectionDemo("Gray");
		
		 System.out.println(!(obj instanceof ReflectionDemo));
